...
**Domain:** Personal developer portfolio + blog (Next.js / Tailwind / MDX, git-based content, $0/month on Vercel)
**Researched:** 2026-07-10
**Confidence:** HIGH (core framework/versions verified via Context7 + official docs), MEDIUM (some npm package versions verified via web search only, not Context7)

This document assumes the stack decision already made in PROJECT.md (Next.js, Tailwind, MDX, Vercel, no CMS, no backend). It fills in the specific libraries and versions to use *within* that stack, current as of mid-2026.
...
npm install remark-gfm rehype-pretty-code rehype-slug rehype-autolink-headings

# Content utilities
npm install reading-time feed
...
**If deploying straight to Vercel (the default for this project):**
...
**If the blog grows to need cross-linking between posts and projects (e.g., "this SaaS project has 3 related blog posts"):**
...
**If Rasmus wants Japanese-language snippets or Aikido terminology in kanji within English posts (not full bilingual i18n, just occasional characters):**
...
**What would trigger cost:** running ads or payment processing on the site itself (commercial-use violation, requires Pro), exceeding 100GB bandwidth (unlikely at personal-site traffic; would require going viral), or wanting more than 1 concurrent build / team collaboration features. None of these are realistic risks for a v1 solo personal site.
...
---
*Stack research for: Personal developer portfolio + blog (Next.js/Tailwind/MDX on Vercel)*
*Researched: 2026-07-10*
